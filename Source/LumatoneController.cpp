...
LumatoneController::LumatoneController(juce::ValueTree state, TerpstraMidiDriver& midiDriverIn, juce::UndoManager* undoManager)
    : LumatoneSandboxState(state, undoManager),
...
//
//FirmwareSupport::Error LumatoneController::handleSerialIdentityResponse(const juce::MidiMessage& midiMessage)
//{
//    int serialBytes[6];
...
//}
//
//FirmwareSupport::Error LumatoneController::handleFirmwareRevisionResponse(const juce::MidiMessage& midiMessage)
//{
